...
namespace IIS.Proba16
{
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba16.ДолжнСотр fДолжнСотр;
        ...
        [PropertyStorage(new string[] {
                "ДолжнСотр"})]
        [NotNull()]
        public virtual IIS.Proba16.ДолжнСотр ДолжнСотр
        {
            get
            {
                ...
                IIS.Proba16.ДолжнСотр result = this.fДолжнСотр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.Proba16.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.Proba16.Сотрудники));
                }
            }
        }
    }
