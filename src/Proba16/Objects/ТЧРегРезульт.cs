...
namespace IIS.Proba16
{
    ...
    public class ТЧРегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba16.ИтогСобес fИтогСобес;
        
        private int fОценкаКандид;
        
        private string fКрКомИлиОбсРеш;
        
        private IIS.Proba16.Сотрудники fСотрудники;
        
        private IIS.Proba16.РегРезульт fРегРезульт;
        ...
        public virtual IIS.Proba16.ИтогСобес ИтогСобес
        {
            get
            {
                ...
                IIS.Proba16.ИтогСобес result = this.fИтогСобес;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Proba16.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Proba16.Сотрудники result = this.fСотрудники;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Proba16.РегРезульт.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РегРезульт"})]
        public virtual IIS.Proba16.РегРезульт РегРезульт
        {
            get
            {
                ...
                IIS.Proba16.РегРезульт result = this.fРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧРегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧРегРезультE", typeof(IIS.Proba16.ТЧРегРезульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧРегРезульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Proba16.DetailArrayOfТЧРегРезульт members)

        // *** End programmer edit section *** (IIS.Proba16.DetailArrayOfТЧРегРезульт members)
        ...
        /// </summary>
        public DetailArrayOfТЧРегРезульт(IIS.Proba16.РегРезульт fРегРезульт) : 
                base(typeof(ТЧРегРезульт), ((ICSSoft.STORMNET.DataObject)(fРегРезульт)))
        {
        }
        
        public IIS.Proba16.ТЧРегРезульт this[int index]
        {
            get
            {
                return ((IIS.Proba16.ТЧРегРезульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Proba16.ТЧРегРезульт dataobject)
        {
