...
namespace IIS.Proba16
{
    ...
    public class ПланирСобес : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba16.РегистАнкеты fРегистАнкеты;
        ...
        [PropertyStorage(new string[] {
                "РегистАнкеты"})]
        [NotNull()]
        public virtual IIS.Proba16.РегистАнкеты РегистАнкеты
        {
            get
            {
                ...
                IIS.Proba16.РегистАнкеты result = this.fРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланирСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесE", typeof(IIS.Proba16.ПланирСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланирСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесL", typeof(IIS.Proba16.ПланирСобес));
                }
            }
        }
    }
